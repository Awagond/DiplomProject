...
public class SettinsActivity extends AppCompatActivity
{
    ...
    private void updateOnlyUserInfo()
    {
        ...
        Toast.makeText(SettinsActivity.this, "Данные профиля успешно обновлены", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    private void userInfoSaved()
    {
        ...
        {
            Toast.makeText(this, "Укажите номер", Toast.LENGTH_SHORT).show();
        }
    ...
    private void uploadImage()
    {
        ...
        {
            Toast.makeText(this, "Отсуствует изображение", Toast.LENGTH_SHORT).show();
        }
    }
