...
public class AdminAddnewProductActivity extends AppCompatActivity
{
    ...
    {
        loadingBar.setTitle("Добавление новый товар");
        loadingBar.setMessage("Подождите пока добавляем товар");
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            {
                Toast.makeText(AdminAddnewProductActivity.this, "Изображение товара успешно добавлено", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(AdminAddnewProductActivity.this, "URL-адрес изображения продукта успешно получен", Toast.LENGTH_SHORT).show();
