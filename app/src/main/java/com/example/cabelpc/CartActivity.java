...
import com.example.cabelpc.Model.Cart;
import com.example.cabelpc.Prevalent.Prevalent;
import com.example.cabelpc.ViewHolder.CartViewHolder;
                        ...
                        cartListRef.child("User View")
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        {
                                            Toast.makeText(CartActivity.this, "Элемент будет удален", Toast.LENGTH_SHORT).show();
        ...
        ordersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
             if(dataSnapshot.exists())
             {
                 ...
                 {
                     txtTotalBtn.setText("Доставка в процессе");
                     recyclerView.setVisibility(View.GONE);
                     Msgtxt.setVisibility(View.VISIBLE);
                     Msgtxt.setText("Поздравляем, ваш заказ будет отправлен");
                     NextProcessBtn.setVisibility(View.GONE);
                     Toast.makeText(CartActivity.this, "Ваш заказ будет в обработке.", Toast.LENGTH_SHORT).show();
